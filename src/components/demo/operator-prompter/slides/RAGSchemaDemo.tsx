...
export function RAGSchemaDemo({ autoStart = false, onComplete, startTrigger = true }: RAGSchemaDemoProps) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto md:h-[600px] h-auto bg-linear-to-br from-slate-50 to-blue-50 rounded-2xl p-4 md:p-8 flex items-center justify-center">
      <div className="w-full flex flex-col items-center gap-4 md:gap-6">
        {/* Row 1: Request Processing */}
        <div className="flex md:flex-row flex-col items-center md:items-center gap-3 md:gap-3">
          <motion.div
        ...
        {/* Row 2: Data Sources */}
        <div className="flex flex-wrap md:flex-nowrap items-center justify-center md:justify-start gap-2 md:gap-3">
