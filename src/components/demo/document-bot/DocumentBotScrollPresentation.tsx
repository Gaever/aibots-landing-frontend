...
export function DocumentBotScrollPresentation() {
  ...
  const sections = [
    ...
    },
    {
      ...content.sections[3],
      demoComponent: (
        <div className="flex flex-col items-center justify-center text-center space-y-8 p-8 bg-linear-to-br from-emerald-600 via-teal-600 to-cyan-700 rounded-2xl w-full h-full">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="px-8 py-4 bg-white text-emerald-600 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all duration-200 hover:scale-105 shadow-xl"
            >
